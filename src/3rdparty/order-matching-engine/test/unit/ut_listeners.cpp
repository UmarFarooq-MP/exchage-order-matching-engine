...
class TradeCbListener : public TradeListener<TypedOrderBook> {
  public:
    virtual void on_trade(const TypedOrderBook* order_book, Quantity qty, Cost cost) {
...
class DepthCbListener : public TypedDepthOrderBook::TypedDepthListener {
  public:
    virtual void on_depth_change(
        const TypedDepthOrderBook* book,
...
class BboCbListener : public TypedDepthOrderBook::TypedBboListener {
  public:
